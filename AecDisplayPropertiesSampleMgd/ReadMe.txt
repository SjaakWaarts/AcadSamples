...
This sample demonstrates the use of the Override Display Properties in AutoCAD Architecture using the .NET API.

Getting Started

Load the project file AecDisplayPropertiesSampleMgd.csproj in Microsoft Visual Studio 2008. You can build the Release and/or the Debug configuration.  You can use the AutoCAD NETLOAD command to load the resulting assembly from the program folder. 

Usage

The extension application implements a command called "DisplayPropertiesSample". 
